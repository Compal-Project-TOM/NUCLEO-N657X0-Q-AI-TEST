...
#define LL_ATON_NETWORK_ORIGIN_MODEL_NAME   "sh_240_quant"
...
#define LL_ATON_NETWORK_IN_1_SIZE_BYTES  (720)

/************************** OUTPUTS *******************************************/
#define LL_ATON_NETWORK_OUT_NUM        (1)    // Total number of output buffers
// Output buffer 1 -- Quantize_291_out_0
#define LL_ATON_NETWORK_OUT_1_ALIGNMENT   (32)
#define LL_ATON_NETWORK_OUT_1_SIZE_BYTES  (15)
